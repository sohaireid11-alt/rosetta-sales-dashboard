...
test("auto-creates care rows for Won leads and leaves them when stage changes", async () => {
  const [wonCare, followUps, followUpUtils, deals, dealId, merge, recordUtils, importRoute] = await Promise.all([
